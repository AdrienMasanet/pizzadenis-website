    ...
    <div className="relative w-full py-28 overflow-hidden">
      ...
      <div ref={sliderRef} className="keen-slider h-full !absolute top-0 -z-10 opacity-40">
        ...
        <div className="keen-slider__slide slider-video">
          <iframe id="ytplayer" width="720" height="405" src="https://www.youtube.com/embed/0MN8ZlGhBoM?autoplay=1&controls=0&disablekb=1&fs=0&loop=1&modestbranding=1&playsinline=1&iv_load_policy=3&start=33&mute=1&playlist=0MN8ZlGhBoM" allow="autoplay" />
        </div>
        <div className="keen-slider__slide">
