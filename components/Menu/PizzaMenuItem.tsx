...
const PizzaMenuItem = ({ pizza }: PizzaMenuItemProps) => {
  return (
    <div className="relative w-auto p-4 font-roastchicken uppercase rounded-lg border border-black/20 overflow-hidden shadow-md">
      ...
      <hr className="relative z-10 my-6 md:my-10 border-none shadow-sm border border-black/50" />
