...
const pizzas: Pizza[] = [
  ...
  { name: "Marius", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.tomato, ingredients.onions, ingredients.tuna, ingredients.pepper, ingredients.cheese], base: pizzaBases.creamBase },
