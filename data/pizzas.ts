...
const pizzas: Pizza[] = [
  ...
  { name: "Laetitia", priceSmall: 10.0, ingredients: [ingredients.tomato, ingredients.onions, ingredients.strasbourgSausages, ingredients.cheese], base: pizzaBases.tomatoBase },
  ...
  { name: "Tramontane", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.molds, ingredients.shrimps, ingredients.calamari, ingredients.cream, ingredients.garlic, ingredients.parsley, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Saumon", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.salmon, ingredients.cream, ingredients.cheese, ingredients.garlic, ingredients.parsley, ingredients.lemon], base: pizzaBases.creamBase },
  { name: "Diana", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.crayfish, ingredients.cream, ingredients.garlic, ingredients.parsley, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Fanny", priceSmall: 10.0, priceBig: 13.0, ingredients: [ingredients.tomato, ingredients.tuna, ingredients.onions, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Marius", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.tomato, ingredients.tuna, ingredients.onions, ingredients.pepper, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Rock", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.roquefort, ingredients.mushrooms, ingredients.cream, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Chèvre", priceSmall: 10.0, priceBig: 13.0, ingredients: [ingredients.goatCheese, ingredients.cream, ingredients.garlic, ingredients.parsley, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "Normande", priceSmall: 10.0, priceBig: 13.0, ingredients: [ingredients.camembert, ingredients.cream, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "3 Fromages", priceSmall: 11.0, priceBig: 14.0, ingredients: [ingredients.roquefort, ingredients.goatCheese, ingredients.cream, ingredients.cheese], base: pizzaBases.creamBase },
  { name: "4 Fromages", priceSmall: 11.5, priceBig: 14.5, ingredients: [ingredients.camembert, ingredients.roquefort, ingredients.goatCheese, ingredients.cream, ingredients.cheese], base: pizzaBases.creamBase },
  ...
  { name: "Gina", priceSmall: 10.0, priceBig: 13.0, ingredients: [ingredients.onions, ingredients.baconBits, ingredients.cheese], base: pizzaBases.creamBase },
  ...
  { name: "Végétarienne", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.tomato, ingredients.mushrooms, ingredients.pepper, ingredients.artichokes, ingredients.cheese], base: pizzaBases.tomatoBase },
  ...
  { name: "Chèvre miel", priceSmall: 10.5, priceBig: 13.5, ingredients: [ingredients.goatCheese, ingredients.cheese, ingredients.cream, ingredients.honey], base: pizzaBases.creamBase },
  { name: "Raclette", priceSmall: 13.0, priceBig: 16.0, ingredients: [ingredients.potatoes, ingredients.ham, ingredients.mushrooms, ingredients.racletteCheese, ingredients.cheese, ingredients.cream], base: pizzaBases.creamBase },
  ...
  { name: "Canigou", priceSmall: 12.0, priceBig: 15.0, ingredients: [ingredients.onions, ingredients.mincedMeat, ingredients.cheese, ingredients.cream], base: pizzaBases.creamBase },
  { name: "Pepper", priceSmall: 12.5, priceBig: 15.5, ingredients: [ingredients.tomato, ingredients.pepperSauce, ingredients.onions, ingredients.mincedMeat, ingredients.cheese], base: pizzaBases.tomatoBase },
  { name: "Stromboli", priceSmall: 13.0, priceBig: 16.0, ingredients: [ingredients.tomato, ingredients.roquefort, ingredients.onions, ingredients.mushrooms, ingredients.mincedMeat, ingredients.cheese], base: pizzaBases.tomatoBase },
  { name: "St Jacques", priceSmall: 12.5, priceBig: 15.5, ingredients: [ingredients.cheese, ingredients.freshScallopsWithCoral, ingredients.cream, ingredients.garlic, ingredients.parsley, ingredients.lemon], base: pizzaBases.creamBase },
];
